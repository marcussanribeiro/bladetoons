...
class CapituloView(models.Model):
    capitulo = models.ForeignKey('Capitulo', on_delete=models.CASCADE, related_name='views')
    user = models.ForeignKey(UsuarioCustom, on_delete=models.CASCADE, null=True, blank=True)
    created_at = models.DateTimeField(default=timezone.now)

    def __str__(self):
        return f"{self.capitulo} - {self.created_at}"
